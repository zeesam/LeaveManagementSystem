  ...
  <div class="row">
    <div class="col-3">
      <div class="d-grid gap-2">
        <a class="btn btn-success" href="{{url('head/regusers')}}">Registered Users</a>
        <a class="btn btn-primary" href="{{url('head/applied')}}">Pending Leaves</a>
        <a class="btn btn-warning" href="{{url('head/admleaves')}}">Administered Leaves</a>
      </div>
    </div>
    <div class="col-9">
    @yield('head')
